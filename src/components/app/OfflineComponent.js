...
export default function OfflineComponent() {
    const container =  { 'background-color':'#191919', 'width':'100%', 'height':'100vh', 'max-width':'1024px', 'margin':'0 auto', 'float':'none','display':'flex','align-items':'center', 'flex-direction':'column', 'justify-content':'center','padding':'1rem', 'box-sizing':'border-box' }
