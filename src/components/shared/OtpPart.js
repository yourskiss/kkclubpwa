...
export default function OtpPart({isMobStatus, getMobNumber, phonenumber}) {
  ...
  const otpSubmit =(e) =>{
    ...
    if (!otpValues){setOtpError("OTP is required!");}
      ...
      setOtpError('');
      if(phonenumber === '9898989898' || phonenumber === '9876543210' || phonenumber === '9090909090' || phonenumber === '9222222222' || phonenumber === '9292929292' || phonenumber === '7111111117') // || phonenumber === '9990499606' || phonenumber === '9212672201')
      {
        verifyDemo();
      }
      else
