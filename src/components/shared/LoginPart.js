  ...
  const mobileSubmit =(e) =>{
    ...
    if (!mobileValues){setMobileError("Please enter your mobile number"); }
      ...
      // console.log("login part", mobileValues);
        if(mobileValues === '9898989898' || mobileValues === '9876543210' || mobileValues === '9090909090' || mobileValues === '9111111111' || mobileValues === '9191919191' || mobileValues === '9000000000') // || mobileValues === '9990499606' || mobileValues === '9212672201')
        {
          sendDemo();
        }
        else
