...
export default function LoginPart({isMobStatus, getMobNumber, phonenumber}) {
  ...
  const mobileSubmit =(e) =>{
    ...
    if (!mobileValues){setMobileError("Please enter your mobile number"); }
      ...
      setMobileError("");  
      // console.log("login part", mobileValues);
        if(mobileValues === '9898989898' || mobileValues === '9876543210' || mobileValues === '9797979797' || mobileValues === '9090909090' || mobileValues === '9111111111' || mobileValues === '9191919191' || mobileValues === '9000000000' || mobileValues === '9000000009' || mobileValues === '7000000007' || mobileValues === '8000000008')
        {
          sendDemo();
        }
        else
